function changeWebPage() {
   ...
   if (zipcode === "02155") {
      window.location.assign("02155.html");
   } else if (zipcode === "02909") {
      window.location.assign("02909.html");
      ...
      window.location.assign("20175.html");
   } else if (zipcode === "21215") {
      window.location.assign("21215.html");
   } else if (zipcode === "22434") {
      window.location.assign("22434.html");
   } else if (zipcode === "23464") {
      window.location.assign("23464.html");
   } else if (zipcode === "30044") {
      window.location.assign("30044.html");
   } else if (zipcode === "32301") {
      window.location.assign("32301.html");
   } else if (zipcode === "37013") {
      window.location.assign("37013.html");
   } else if (zipcode === "45321") {
      window.location.assign("45321.html");
   } else if (zipcode === "60625") {
      window.location.assign("60625.html");
      ...
      window.location.assign("85028.html");
   } else if (zipcode === "85032") {
      window.location.assign("85032.html");
   } else if (zipcode === "85254") {
      window.location.assign("85254.html");
   } else if (zipcode === "87111") {
      window.location.assign("87111.html");
   } else if (zipcode === "87124") {
      window.location.assign("87124.html");
   } else if (zipcode === "90011") {
      window.location.assign("90011.html");
   } else if (zipcode === "92335") {
      window.location.assign("92335.html");
   } else if (zipcode === "94112") {
      window.location.assign("94112.html");
   } else if (zipcode === "94538") {
      window.location.assign("94538.html");
   } else if (zipcode === "95823") {
      window.location.assign("95823.html");
   } else if (zipcode === "96818") {
      window.location.assign("96818.html");
   } else if (zipcode === "98115") {
      window.location.assign("98115.html");
   } else if (zipcode === "99516") {
      window.location.assign("99516.html");
   } else {
